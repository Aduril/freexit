defmodule FreexitWeb.UserAuthTest do
  use FreexitWeb.ConnCase, async: true

  alias Freexit.Accounts
  alias FreexitWeb.UserAuth
  import Freexit.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FreexitWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FreexitWeb.Endpoint.subscribe(live_socket_id)
